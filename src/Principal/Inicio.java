...
public class Inicio extends javax.swing.JFrame {
    ...
    private void cargarInformacion(){
        try {
            Object o[]=null;
            List<Inscripcion> listaIns=ins.findInscripcionEntities();
            ...
            for(int i=0;i<listaIns.size();i++){
                ...
                modelo2.setValueAt(listaIns.get(i).getCursoIdcurso(),i, 2);
                modelo2.setValueAt(listaIns.get(i).getAlumnoDni(),i, 3);
